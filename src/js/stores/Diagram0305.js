...
class Connector0305 extends EventEmitter {
  constructor() {
    super()
    this.pages = [
      ...
      {id:'2N',wirecolor:'VTSC',function:'VTCS', mscolor:'LTGRNB', pin:'X - 25', output:'NTRS2', squarecolor:'filled', fullfunction:'Variable Tumble Control System (VTCS)', fullcolor:'Lt Green/Blue'},
      {id:'2O',wirecolor:'',function:'', mscolor:'', pin:'', output:'', squarecolor:'', fullfunction:'', fullcolor:''},
      {id:'2P',wirecolor:'+12v',function:'+12v', mscolor:'R', pin:'MS - 29', output:'(Idle)', squarecolor:'filled', fullfunction:'+12v Idle Valve Power', fullcolor:'Red'},
      ...
      {id:'3H',wirecolor:'MRELAY',function:'MRELAY', mscolor:'O', pin:'MS - 3', output:'WLED', squarecolor:'O BTXT', fullfunction:'Main Relay Switch', fullcolor:'Orange'},
      ...
      {id:'4D',wirecolor:'VVT PWR',function:'+12v', mscolor:'R', pin:'MS - 30', output:'', squarecolor:'filled', fullfunction:'+12v VVT Solenoid Power', fullcolor:'Red'},
      ...
      {id:'4L',wirecolor:'5VREF',function:'5VREF', mscolor:'G', pin:'MS - 26', output:'', squarecolor:'filled', fullfunction:'5v Reference', fullcolor:'Gray'},
      {id:'4M',wirecolor:'KNOCK',function:'KNCK', mscolor:'OR', pin:'MS - 5', output:'SPR3', squarecolor:'OR BTXT', fullfunction:'Knock Sensor Input', fullcolor:'Orange/Red'},
      {id:'4N',wirecolor:'AIT',function:'AIT', mscolor:'O', pin:'MS - 20', output:'', squarecolor:'filled', fullfunction:'Air Intake Temperature Sensor', fullcolor:'Orange'},
      ...
      {id:'4R',wirecolor:'VVT',function:'VVT', mscolor:'LTGRN', pin:'X - 24', output:'NTRS1', squarecolor:'filled', fullfunction:'VVT Solenoid', fullcolor:'Lt Green'},
...
const connector0305 = new Connector0305;

export default connector0305;
