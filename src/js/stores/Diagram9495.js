...
class Diagram9495 extends EventEmitter {
  constructor() {
    ...
    this.pages = [
      ...
      {id:'1D',wirecolor:'W/G',function:'', mscolor:'', pin:'', squarecolor:'', fullfunction:'', fullcolor:''},
      ...
      {id:'1L',wirecolor:'B/G',function:'FAN', mscolor:'WB',pin:'X - 1', output:'INJ G', squarecolor:'filled', fullfunction:'Main Fan Output', fullcolor:'White/Blue'},
      {id:'1M',wirecolor:'R/G',function:'VSS IN', mscolor:'GV', pin:'X - 28', output:'TBSWCH', squarecolor:'filled', fullfunction:'Vehicle Speed Sensor', fullcolor:'Gray/Purple'},
      {id:'1N',wirecolor:'R',function:'', mscolor:'', pin:'', squarecolor:'', fullfunction:'', fullcolor:''},
      ...
      {id:'1R',wirecolor:'Y',function:'KNOCK', mscolor:'OR', pin:'MS - 5', output:'SPR 3', squarecolor:'filled', fullfunction:'Added Knock Sensor (via Purge Valve)', fullcolor:'Orange/Red'},
      ...
      {id:'2K',wirecolor:'LG/W',function:'5V REF', mscolor:'G', pin:'MS - 26', squarecolor:'filled', fullfunction:'5v Reference', fullcolor:'Gray'},
      {id:'2L',wirecolor:'L/R',function:'', mscolor:'', pin:'', squarecolor:'', fullfunction:'', fullcolor:''},
      {id:'2M',wirecolor:'R/B',function:'TPS', mscolor:'BL', pin:'MS - 22', output:'', squarecolor:'filled', fullfunction:'Throttle Position Sensor', fullcolor:'Light Blue'},
      ...
      {id:'2O',wirecolor:'R/W',function:'EBC', mscolor:'GRNR', pin:'X - 6', output:'(MAF)', squarecolor:'filled', fullfunction:'Boost Control', fullcolor:'Green/Red'},
      ...
      {id:'2R',wirecolor:'Y/G',function:'VVT', mscolor:'LTGRN', pin:'X - 24', output:'(FPR)', squarecolor:'filled', fullfunction:'VVT Output (VVT Swaps Only)', fullcolor:'Light Green'},
      {id:'2S',wirecolor:'L/W',function:'A/C FAN', mscolor:'WG', pin:'X - 4', output:'INJ F', squarecolor:'filled', fullfunction:'A/C Fan Output', fullcolor:'White/Green'},
      {id:'2T',wirecolor:'LG',function:'FUELP', mscolor:'V', pin:'MS - 37', output:'', squarecolor:'filled', fullfunction:'Fuel Pump Output', fullcolor:'Purple'},
      {id:'2U',wirecolor:'Y',function:'INJ A', mscolor:'W', pin:'X - 19', output:'(Cly 1)', squarecolor:'filled', fullfunction:'Injector A', fullcolor:'White'},
      {id:'2V',wirecolor:'Y/B',function:'INJ D', mscolor:'WP', pin:'X - 10', output:'(CLY 2)', squarecolor:'filled', fullfunction:'Injector D', fullcolor:'White/Pink'},
      ...
      {id:'2Y',wirecolor:'G/W',function:'INJ B', mscolor:'WO', pin:'X - 16', output:'(Cly 3)', squarecolor:'filled', fullfunction:'Injector B', fullcolor:'White/Orange'},
      {id:'2Z',wirecolor:'G',function:'INJ C', mscolor:'WLTGRN', pin:'X - 13', output:'(Cly 4)', squarecolor:'filled', fullfunction:'Injector C', fullcolor:'White/Green'},
    ];
  }
