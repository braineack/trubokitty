...
class Connector0105 extends EventEmitter {
  constructor() {
    ...
    this.pages = [
      ...
      {id:'3H',wirecolor:'MRELAY',function:'MRELAY', mscolor:'LTGRN', pin:'X - 24', output:'NTRS1', squarecolor:'LTGRN'},
      ...
      {id:'4D',wirecolor:'',function:'', mscolor:'', pin:'', output:'', squarecolor:''},
      ...
      {id:'4M',wirecolor:'KNOCK',function:'KNCK', mscolor:'OR', pin:'MS - 5', output:'SPR3', squarecolor:'filled'},
      {id:'4N',wirecolor:'',function:'', mscolor:'', pin:'', output:'', squarecolor:''},
      ...
      {id:'4R',wirecolor:'AIT',function:'AIT', mscolor:'O', pin:'MS - 20', output:'', squarecolor:'filled'},
      {id:'4S',wirecolor:'+12v',function:'+12v', mscolor:'R', pin:'MS - 28', output:'', squarecolor:'filled'},
      ...
      {id:'4AF',wirecolor:'',function:'', mscolor:'', pin:'', output:'', squarecolor:''},
