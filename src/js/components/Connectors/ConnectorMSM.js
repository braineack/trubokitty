...
import DiagramMSM from "../../stores/DiagramMSM";
...
export default class ConnectorMSM extends React.Component {
  renderSquare(i) {
  ...
  render() {
      return (
        <div>
        <h1>Mazdaspeed Miata (MSM) MS3x Wiring Diagram</h1>
        <div class="row">
